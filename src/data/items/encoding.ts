...
export const ENCODING: Item[] = [
  ...
  { id: 'hamming-code', name: 'Hamming Code', emoji: '🛡️', category: 'encoding', rarity: 'epic', milestone: '1950', description: 'An error-correcting code that can detect and fix single-bit errors using extra parity bits.' },
  ...
  { id: 'reed-solomon-code', name: 'Reed-Solomon Code', emoji: '💿', category: 'encoding', rarity: 'legendary', milestone: '1960', description: 'An error-correcting code that can recover from burst errors, used in CDs, QR codes, and deep-space links.' },
  { id: 'entropy', name: 'Entropy (Shannon Entropy)', emoji: '🌫️', category: 'encoding', rarity: 'rare', milestone: '1948', description: 'A measure of the average uncertainty, or information content, produced by a random source.' },
  ...
  { id: 'shannons-noisy-channel-theorem', name: "Shannon's Noisy Channel Coding Theorem", emoji: '📶', category: 'encoding', rarity: 'legendary', milestone: '1948', description: 'The theorem proving that reliable communication is possible at any rate below channel capacity.' },
